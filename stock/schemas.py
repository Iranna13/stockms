...
class Query:
    ...
    @strawberry.field
    def getProductsBySupplierOrderDate(supplier_order_date: str) -> List[ProductSchema]:
        product_dao = ProductDAO(session)
    ...
    @strawberry.field
    def get_category_by_product_id(self, product_id: int) -> List[CategorySchema]:
        categories = (
    ...
    @strawberry.field
    def get_products_by_categoryid(self, category_id: int) -> List[ProductSchema]:
        product_dao = ProductDAO(session)
        products = product_dao.get_products_by_categoryid(category_id)
        return [
            ProductSchema(
                id=product.id,
                category_id=product.category_id,
    ...
    @strawberry.field
    def get_products_by_category_name(category_name: str) -> List[Product]:
        product_dao = ProductDAO(session)
